...
## ▶️ Parte 2: como faço o projeto rodar?
...
> [!WARNING]
> Ninguém registrou ainda o jogo rodando no computador. Se a janela não
> abrir, ou o mapa aparecer de cabeça para baixo, isso é uma descoberta
> importante. [Abra uma issue](https://github.com/Lhordrixon/mundo-vivo/issues/new/choose)
> com o erro ou uma captura de tela.

---

## 🛠️ Parte 3: como faço minha primeira contribuição?
...
Se não houver nenhuma, escolha um item marcado com 🌱 em
[docs/divida-tecnica.md](docs/divida-tecnica.md). Abra uma issue dizendo
que vai fazê-lo.

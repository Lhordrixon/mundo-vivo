...
Este é o conteúdo técnico que ficava no README, movido para cá sem cortes
enquanto a documentação é dividida por assunto. Para começar, leia o
[README](../README.md) e o [COMECE-AQUI](../COMECE-AQUI.md). O progresso
de cada funcionalidade está no [roadmap](roadmap.md).

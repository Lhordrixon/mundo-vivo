# Facções e território

A que reino cada criatura pertence, e de quem é cada pedaço de terra.
...
diferentes brigam quando se encontram. O território de cada reino é
recalculado uma vez por segundo.
